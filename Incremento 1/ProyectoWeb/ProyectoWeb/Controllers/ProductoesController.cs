...
namespace ProyectoWeb.Controllers
{
    public class ProductoesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "IDProducto,Nombre,Precio,Cantidad,IDProveedor,IDCategoria,Foto")] Producto producto)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "IDProducto,Nombre,Precio,Cantidad,IDProveedor,IDCategoria,Foto")] Producto producto)
        {
            if (ModelState.IsValid)
            {
